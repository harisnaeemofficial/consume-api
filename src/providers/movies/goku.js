...
class Goku {
  ...
  logo =
    "https://img.goku.to/xxrz/400x400/100/9c/e7/9ce7510639c4204bfe43904fad8f361f/9ce7510639c4204bfe43904fad8f361f.png";
  ...
  async Search(query, page = 1) {
    ...
    try {
      ...
      const navSelector =
        "div.section-pagination:nth-child(1) > nav:nth-child(1) > ul:nth-child(1)";
      ...
      $("div.section-items > div.item").each((i, el) => {
        ...
        searchResult.results.push({
          id: $(el)
            .find("div.movie-thumbnail > a:nth-child(2)")
            .attr("href")
            ?.slice(1),
          ...
          type:
            releaseDate.toLocaleLowerCase() !== "Tv"
              ? TvType.MOVIE
              : TvType.TVSERIES,
        });
      });
